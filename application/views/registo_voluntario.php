...
<html lang="en">
	...
	<body id="page-top">
		...
		<header style="background-image: url(<?php echo base_url('assets/reg_vol.jpg'); ?>);">
			<div class="header-content">
				<div class="header-content-inner">
					<h1>Registo como Voluntário</h1>
					<hr>
					<p>
					...
					<a href="#about" class="btn btn-primary btn-xl page-scroll" style="outline:none">REGISTA-TE AQUI</a>
				</div>
			</div>
		</header>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" size="30" value="" name="username" class="form-control" id="username" placeholder="Nome de Utilizador" required>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select name="profissao" class="js-example-basic-single col-sm-8">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select name="genero" class="js-example-basic-single col-sm-6">
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="datanascimento"  aria-describedby="sizing-addon2">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6" style="margin-top:20px">
								<div class="input-group">
									...
									<input type="text" class="col-sm-6" name="cv" style=" width:670px; color:black;" />
								</div>
							</div>
							<!--
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="disponibilidade"  aria-describedby="sizing-addon2">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="email" value="" id="email" maxlength="80" size="30" type="text" class="form-control" placeholder="Email" aria-describedby="sizing-addon2" required>
