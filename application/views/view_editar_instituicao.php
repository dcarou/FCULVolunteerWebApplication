...
<html lang="en">
	...
	<head>
		...
		<title>Volunteer@FC.UL: Edição de Perfil de Instituição</title>
	...
	foreach ($instituicao as $lin) {
		$website = $lin["WEBSITE"];
	}
	foreach ($representante as $lin) {
		$nomerepres = $lin["NOME"];
		$emailrepres = $lin["EMAIL"];
	}
	?>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a class="page-scroll" href="<?php echo site_url('autenticacao_instituicao/login'); ?>">Página Instituição</a>
						</li>
		...
		<header style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(<?php echo base_url('assets/editar_perfil.jpg'); ?>);">
			<div class="header-content">
				<div class="header-content-inner">
					<h1>Alterar Perfil de Instituição</h1>
					<hr>
					<br>
					<br>
					<br>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" size="30" name="email" class="form-control" id="email" value="<?php echo $email; ?>" required>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" size="30" name="representante" class="form-control" id="representante" value="<?php echo $nomerepres; ?>" required>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" size="30" name="emailrepresentante" class="form-control" id="emailrepresentante" value="<?php echo $emailrepres; ?>" required>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6" style="margin-top:20px">
								<div class="input-group">
									...
									<input type="text" class="col-sm-6" name="morada" value="<?php echo $distrito; ?>" style=" width:670px; color:black;" />
								</div>
							</div>
						</div>
					</div>
