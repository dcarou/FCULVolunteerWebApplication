...
<html lang="en">
	...
	<body id="page-top">
		...
		<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand page-scroll" href="<?php echo site_url(); ?>" >Bolsa de Voluntariado da FCUL</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle profile-image" data-toggle="dropdown"> <img src="<?php echo $fotografia; ?>" style="height:30px;width:30px; margin-top: -5px;" class="img-circle special-img"> <?php echo $username ?> <b class="caret"></b> </a>
		...
		<header style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(<?php echo base_url('assets/editar_perfil.jpg'); ?>);">
			<div class="header-content">
				<div class="header-content-inner">
					<h1>Alterar Perfil de Voluntário</h1>
					<hr>
					<br>
					<br>
					<br>
					...
					<br>
					<br>
					<a href="#about" class="btn btn-primary btn-xl page-scroll" style="outline:none">Alterar Perfil</a>
				</div>
			</div>
		</header>
		...
		<section class="bg-primary" id="about">
			...
			<div class="container">
				<form action="update_user_info" method="POST" accept-charset="utf-8" id="buttonGroupForm" class="form-horizontal" role="form">
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									<span class="input-group-addon" id="sizing-addon2">Nome de Utilizador</span>
									<input type="text" size="30" name="username" class="form-control" id="username" value="<?php echo $username; ?>" required>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select class="js-example-basic-single col-sm-8" name="profissao">
										<option value="" selected disabled>Chose</option>
										<option value="ESTUDANTE">Estudante</option>
										<option value="ACTOR">Actor</option>
										<option value="ADMINISTRATIVO">Administrativo</option>
										<option value="ADVOGADO">Advogado</option>
										<option value="AGENTEDESEGUROS">Agente de Seguros</option>
										...
										<option value="FOTÃ“GRAFO">Fotógrafo</option>
										<option value="GEÓGRAFO">Geógrafo</option>
										<option value="GEÒLOGO">Geólogo</option>
										...
										<option value="MECANICO">Mecâcico</option>
										...
										<option value="REVISOR OFICIAL DE CONTAS">Revisor Oficial de Contas</option>
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select class="js-example-basic-single col-sm-6" name="genero" >
										<option value="" selected disabled>Chose</option>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select id="ddl" onchange="configureDropDownLists(this,document.getElementById('ddl2'))" class="js-example-basic-single col-sm-10" name="distrito" style="outline:none">
										<option value="" selected disabled>Chose</option>
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select id="ddl2" class="js-example-basic-single col-sm-10" name="concelho" selected="<?php echo $concelho; ?>"></select>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="datanascimento" value="<?php echo $data; ?>" aria-describedby="sizing-addon2">
								</div>
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6" style="margin-top:20px">
								<div class="input-group">
									<span class="input-group-addon" id="sizing-addon2">CV: </span>
									<input type ="text" class="col-sm-6" name="cv" value="<?php echo $cv; ?>" style=" width:670px; color:black;" />
								</div>
							</div>
							<!--
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6" style="margin-top:10px">
								<div class="input-group">
									...
									<input type="text" class="col-sm-6" value="<?php echo $fotografia; ?>" name="fotografia" style="width: 637px; color:black;" />
								</div>
							</div>
					...
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									<span class="input-group-addon" id="sizing-addon2" style="text-align:left">Resumo </span>

								</div>
							</div>
							<div class="col-sm-12">
								<div class="input-group">
									<textarea name="descricao" style="height: 100px; width: 721px; color:black;"><?php echo "$descricao"; ?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-12">
								<div class="input-group">
									...
									<select id="dropdown-checklist" name="areas[]" multiple="multiple" class="js-example-basic-single " style="width:570px;">
													
										<?php 
											foreach ($user['myareas'] as $ar){
												foreach ($ar as $k => $a) {
													echo "<option value=\"". $a ."\" selected=\"selected\">". $areas[$a]['TIPO'] ."</option>)";
													unset($areas[$a]);
												}
											}
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-11">
								<div class="input-group">
									...
									<select id="dropdown-checklist" name="grupos[]" multiple="multiple" class="js-example-basic-single" style="width:620px;">
										
										<?php 
										
											foreach ($user['mygrupos'] as $ar){
												foreach ($ar as $k => $a) {
													echo "<option value=\"". $a ."\" selected=\"selected\">". $grupos[$a]['TIPO'] ."</option>)";
													unset($grupos[$a]);
												}
											}
										
											$i = 0;
											foreach ($grupos as $ar) {
												foreach ($ar as $k => $a) {
													echo "<option value=\"". $i ."\">". $a ."</option>)";
													$i++;
												}
					...
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon" id="sizing-addon2">Disponibilidade a partir de:</span>
									<input type="text" class="form-control" name="disponibilidade" placeholder="29/04/2016" aria-describedby="sizing-addon2">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="email" id="email" maxlength="80" size="30" type="text" class="form-control" value="<?php echo $email; ?>" aria-describedby="sizing-addon2" required>
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="telefone" type="text" class="form-control" value="<?php echo $telefone; ?>" aria-describedby="sizing-addon2">
								</div>
							</div>
						</div>
					</div>
...
-->
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-10" style="text-align:center;">
							<input  type="submit" name="" value="Actualizar Perfil" id="reg_vol" class="btn btn-primary btn-xl page-scroll" style="outline:none;color:black; background-color:white"/>
						</div>
					</div>
				</form>
			</div>
