...
<head>
    ...
    <title>Volunteer@FC.UL: Perfil da Instituição</title>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="<?php echo site_url('instituicao/paginaInicial'); ?>">Bolsa de Voluntariado da FCUL</a>
            </div> 
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
             <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href="<?php echo site_url('instituicao/paginaInicial'); ?>">Página Instituição</a>
                    </li>  
                        ...
                        <a href="#" class="dropdown-toggle profile-image" data-toggle="dropdown" aria-expended="false" style="height: 50px; margin-top:-5px;">
                            <img src="<?php echo $fotografia ?>" style="width:30px;height:30px;" class="img-circle special-img"> <?php echo $username ?> <b class="caret"></b>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo site_url('instituicao/paginaEditarPerfil'); ?>"><i class="fa fa-edit"></i> Editar Perfil </a></li>
                                    <li class="divider"></li>
                                    <li><a href="<?php echo site_url('autenticacao_instituicao/logout'); ?>"><i class="fa fa-sign-out"></i> Terminar Sessão</a></li>
				...
				<div class="row">
						<div class="col-sm-12">
							...
							<div style="float: left;">
								<h2 style="display:inline;text-align:left">Nome: </h2>
								<h4 style="color:black; display:inline;"><?php echo $username ?></h4>
							</div>
							...
							<div style="float: left">
								<h2 style="display:inline;text-align:left">Email: </h2>
								<h4 style="color:black;display:inline;"> <?php echo $email ?> </h4>
							</div>
							...
							<div style="float: left">
								...
								<h4 style="color:black;display:inline;"><?php echo $telefone ?></h4>
							</div>
							...
							<div style="float: left">
								<h2 style="display:inline;text-align:left">Morada: </h2>
								<h4 style="color:black;display:inline;"><?php echo "morada" ?></h3>
							</div>
							...
							<div class="col-sm-5">
								...
								<div>
									<a target="_blank" href="<?php echo $website ?>" style="color:#f05f40"><h2 style=" right;">Website</h2></a>
								</div>
							...
							<div class="col-sm-4">
								...
								<table>
                             		<tr>
                           			...
                           			<tr>
                               			<h4 style="color:black;">Jamie Vardy: </h4>
                          			</tr>
                            		<tr>        
                                		<h4 style="color:black;">Tozé Marreco: </h4>
                            		</tr>
                        		</table>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<br >
							<div style="float: left">
								<h2 style="display:inline;">Porquê nós</h2>
							</div>
							<br>
							<br>
							<div style="float: left">
